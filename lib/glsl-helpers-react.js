...
var GlslCanvas = /*#__PURE__*/function (_Component) {
  function GlslCanvas(props) {
    ...
    src_defineProperty(_this, "toShaderPixelCoords", function (clientX, clientY) {
      var _this$props$devicePix3;
      var rect = _this.canvas.getBoundingClientRect();
      var dpr = (_this$props$devicePix3 = _this.props.devicePixelRatio) !== null && _this$props$devicePix3 !== void 0 ? _this$props$devicePix3 : 1;
      var x = (clientX - rect.left) * dpr;
      var y = (rect.height - (clientY - rect.top)) * dpr;
      return [x, y];
    });
    ...
    src_defineProperty(_this, "onResize", function () {
      ...
      var _this$props$devicePix4 = _this.props.devicePixelRatio,
        devicePixelRatio = _this$props$devicePix4 === void 0 ? 1 : _this$props$devicePix4;
      _this.canvasPosition = _this.canvas.getBoundingClientRect();
    ...
    src_defineProperty(_this, "compileShaders", function () {
      ...
      if (passes && passes.length > 0) {
        ...
        _this.passPrograms = passes.map(function (pass) {
          var channelOffset = (pass.inputs || []).length;
          var shaders = _this.preProcessShaders(pass.fs, vs || defaultVs, pass.fs, channelOffset);
