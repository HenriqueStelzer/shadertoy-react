...
**Status:** On `main`; tagged [`v2.0.0`](https://github.com/HenriqueStelzer/glsl-helpers-react/releases/tag/v2.0.0) at `ebd5404`. Remaining: `npm publish` (requires npm auth).

**Deliverables**

- [x] Merge 2.0 release branch into `main`
- [x] Copilot review fixes (reactive props, WebGL2 formats, multi-pass channels)
- [x] Tag `v2.0.0` at `ebd5404`
- [ ] `npm publish` from tag: `git checkout v2.0.0 && npm run publish-npm`

**Depends on:** [Changelog](changelog/README.md) aligned with tag (9 released commits + 3 post-tag doc commits)
...
*Last updated: 2026-06-09. P0 repo hygiene targets 2.0.1; feature work follows 2.0.0 npm publish.*
